...
class PipelineDashboard:
        ...
        try:
            ...
            dashboard_data = {
                **base_data,
                ...
                "recommendations": self._get_improvement_recommendations(repository, days),
            }
    ...
    def _calculate_health_metrics(
        ...
        try:
            ...
            health_score = self._calculate_health_score(success_rate, avg_duration, len(failed_runs))
        ...
        try:
            ...
            for failure in failures:
                ...
                if date in daily_failures:
                    ...
                    daily_categories[date][category] = daily_categories[date].get(category, 0) + 1
            
            # Calculate trend direction
            recent_avg = sum(list(daily_failures.values())[:3]) / 3 if days >= 3 else 0
            older_avg = sum(list(daily_failures.values())[-3:]) / 3 if days >= 6 else recent_avg
            ...
            return {
                ...
                "trend_percentage": round(((recent_avg - older_avg) / (older_avg or 1)) * 100, 1)
            }
    ...
    def _get_alert_summary(
        ...
        try:
            ...
            return {
                ...
                "requires_attention": alert_counts["critical"] + alert_counts["high"] > 0
            }
    ...
    def get_live_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            running_pipelines = [r for r in recent_runs if r.status.value == "in_progress"]
