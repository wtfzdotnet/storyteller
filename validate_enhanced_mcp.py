...
def validate_enhanced_mcp():
    ...
    try:
        ...
        context = {"component_name": "TestComponent", "props_interface": "", "props_destructure": "", "container_class": "test"}
    ...
    if passed_tests == total_tests:
        ...
        print(f"⚠️ {total_tests - passed_tests} validations failed. Review above errors.")
        return False
