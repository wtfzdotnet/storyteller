...
class TestManualInterventionIntegration(unittest.TestCase):
    ...
    def test_full_manual_intervention_workflow(self):
        ...
        human_decision = (
            "Approved with modifications: implement feature X with approach Z instead"
        )
        human_rationale = """
    ...
    def test_multiple_interventions_workflow(self):
        ...
        self.assertEqual(
            intervention_3.human_decision, "Approved with major modifications"
        )
    ...
    def test_intervention_automatic_detection(self):
        ...
        for i, test_case in enumerate(test_cases):
            ...
            requires_intervention, reason = (
                engine.check_consensus_requires_intervention(consensus)
            )
