...
def test_template_system():
    ...
    context = {
        ...
        "attributes": [
            {
                "name": "logger",
                "type_annotation": "logging.Logger",
    ...
    try:
        react_code = template_manager.render_template(
...
async def test_mcp_server_integration():
    ...
    try:
        ...
        if response.error:
            ...
            print(
                f"   📦 Generated component: {len(result.get('component_code', ''))} chars"
            )
...
def test_ruleset_application():
    ...
    scenarios = [
        ...
        },
        {
            ...
            "platforms": [
                PlatformChoice.REACT,
                PlatformChoice.VITE,
                PlatformChoice.TAILWIND,
            ],
            "expected_actions": [
        ...
        },
        {
            ...
            "platforms": [
                PlatformChoice.REACT,
                PlatformChoice.STORYBOOK,
                PlatformChoice.TAILWIND,
            ],
            "expected_actions": [
                "generate_comprehensive_tests",
                "generate_advanced_storybook",
                "api_documentation",
            ],
        },
    ]
    ...
    for scenario in scenarios:
        ...
        for ruleset_name, ruleset in rulesets.items():
            if ruleset.language == scenario["language"] and set(
                ruleset.platforms
            ).intersection(set(scenario["platforms"])):
