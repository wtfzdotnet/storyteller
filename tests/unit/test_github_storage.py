...
from github_storage import (
    ...
    GitHubIssueMetadata,
    StorageConfig as GSStorageConfig
)
from models import Epic, UserStory, SubStory, StoryStatus, StoryType
...
This is the epic description with detailed requirements."""
        ...
        self.assertEqual(epic.description, "This is the epic description with detailed requirements.")
        ...
        self.assertEqual(epic.acceptance_criteria, ["Feature works correctly", "Performance is acceptable"])
