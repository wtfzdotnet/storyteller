...
class TestPipelineMonitoringIntegration:
    ...
    async def test_complete_pipeline_failure_workflow(self):
        ...
        with patch('webhook_handler.DatabaseManager') as mock_db, \
            ...
            mock_monitor_instance.process_pipeline_event.return_value = mock_pipeline_run
            ...
            mock_monitor_instance.process_pipeline_event.assert_called_once_with(webhook_payload)
    ...
    async def test_low_severity_failure_no_notification(self):
        ...
        with patch('webhook_handler.DatabaseManager') as mock_db, \
            ...
            mock_monitor.return_value.process_pipeline_event.return_value = mock_pipeline_run
    ...
    def test_failure_classification_accuracy(self):
        ...
        with patch('pipeline_monitor.DatabaseManager'), \
            ...
            category, severity = monitor._classify_failure(
                "Lint and Format", 
                "flake8 error: E401 multiple imports on one line"
            )
            ...
            category, severity = monitor._classify_failure(
                "Run Tests",
                "FAILED tests/test_api.py::test_user_auth - AssertionError"
            )
    ...
    def test_dashboard_data_structure(self):
        ...
        with patch('pipeline_dashboard.DatabaseManager') as mock_db, \
    ...
    def test_workflow_processor_integration(self):
        ...
        with patch('automation.workflow_processor.StoryManager'), \
    ...
    async def test_end_to_end_monitoring_flow(self):
        ...
        with patch('webhook_handler.DatabaseManager'), \
