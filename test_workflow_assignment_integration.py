...
from automation.workflow_processor import WorkflowProcessor, WorkflowResult
...
class TestWorkflowProcessorAssignment(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('automation.workflow_processor.StoryManager') as mock_story_manager:
            ...
            with patch('automation.workflow_processor.LabelManager') as mock_label_manager:
    ...
    async def test_process_story_assignment_not_eligible(self):
        ...
        async def run_test():
            ...
            story_content = "Redesign entire system architecture with complex security requirements"
    ...
    async def test_assignment_with_github_integration(self):
        ...
        async def run_test():
            ...
            story_metadata = {
                "github_issues": [
                    {"repository": "test-repo", "issue_number": 123}
                ]
            }
