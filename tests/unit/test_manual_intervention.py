...
from src.storyteller.models import ManualIntervention, ConsensusResult, ConsensusStatus
...
class TestManualIntervention(unittest.TestCase):
    ...
    def test_manual_intervention_audit_trail(self):
        ...
        self.assertEqual(intervention.audit_trail[0]["action"], "intervention_triggered")
        self.assertEqual(intervention.audit_trail[1]["actor"], "project-manager:john_doe")
    ...
    def test_database_get_interventions_by_conversation(self):
        ...
        pending_interventions = self.db.get_interventions_by_conversation("conv_123", status="pending")
...
class TestConversationManagerIntervention(unittest.TestCase):
    ...
    async def test_conversation_manager_intervention_workflow(self):
        ...
        try:
            ...
            self.assertEqual(updated_status["human_decision"], "Approved with conditions")
