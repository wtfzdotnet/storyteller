...
def demo_epic_api(base_url="http://localhost:8000"):
    ...
    epic_data = {
        ...
        "description": "Implement comprehensive user authentication and authorization system with OAuth2, JWT tokens, and role-based access control",
        "business_value": "Enables secure user access, protects sensitive data, and provides foundation for personalized features",
        "acceptance_criteria": [
    ...
    if response.status_code == 200:
        ...
        print(f"✅ Epic updated successfully!")
    ...
    if response.status_code == 200:
        ...
        print(f"✅ Epic hierarchy retrieved!")
